...
public class VerificationCodeUtils {
    ...
    public String generateVerificationCode(Long userId) {
        ...
        VerificationCode verificationCode = new VerificationCode(code, System.currentTimeMillis(), userId);
    ...
    public Long getUserIdByCode(String code) {
        VerificationCode verificationCode = verificationCodes.get(code);
        return (verificationCode != null && !isCodeExpired(verificationCode)) ? verificationCode.getUserId() : null;
    }
    ...
    private static class VerificationCode {
        ...
        public VerificationCode(String code, long creationTime, Long userId) {
            this.code = code;
